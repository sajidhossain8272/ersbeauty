...
export default function CartDrawer() {
  ...
  const handleSubmitOrder = async (e: React.FormEvent) => {
    ...
    // Basic phone validation (Bangladeshi formats)
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" aria-modal="true" role="dialog">
      ...
      <div className="fixed inset-y-0 right-0 pl-10 max-w-full flex">
        <div className="w-screen max-w-md bg-white flex flex-col shadow-2xl animate-slideLeft">
          
          {/* Header */}
          <div className="px-4 py-5 border-b border-gray-150 flex items-center justify-between bg-gray-50">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-6">
            {orderPlaced ? (
              ...
              <div className="text-center py-8 space-y-5 animate-scaleUp">
                ...
                <div>
                  <h3 className="text-xl font-black text-emerald-600">অর্ডারটি সফল হয়েছে!</h3>
                  <p className="text-xs font-semibold text-gray-500 mt-1">
                    অর্ডারটি সফলভাবে সম্পন্ন হয়েছে। আমাদের প্রতিনিধি শীঘ্রই আপনার নাম্বারে কল করবেন।
                  </p>
                </div>
                  ...
                  <div className="pt-2 border-t border-emerald-100/50">
                    ...
                    {placedOrderDetails?.items.map((item: any, i: number) => (
                      <p key={i} className="text-gray-600 font-semibold pl-2">
                        • {item.name} (${item.brand}) - {item.quantity} টি x ৳{item.price}
                      </p>
                    ))}
                  </div>
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs font-semibold text-gray-500 mt-1">
                    ব্যাগ-এ কোনো পণ্য নেই। পণ্য যোগ করতে এখনই শপ করুন।
                  </p>
                </div>
                <button
                  type="button"
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <p className="text-xs font-black text-gray-400 uppercase tracking-wider">পণ্য তালিকা</p>
                  {cartItems.map((item) => (
                    <div key={item.id} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-150">
                      <div className="relative w-16 h-16 bg-white border border-gray-100 rounded-lg overflow-hidden shrink-0 flex items-center justify-center p-1">
                        <Image 
                          src={item.imageUrl} 
                          alt={item.name} 
                          width={60} 
                      ...
                      <div className="flex-1 min-w-0">
                        <span className="text-[10px] font-black text-brand-blue block uppercase leading-none">
                          {item.brand}
                        </span>
                ...
                <div className="space-y-4 pt-2">
                  <p className="text-xs font-black text-gray-400 uppercase tracking-wider">ডেলিভারি ও কাস্টমার তথ্য</p>
                  ...
                  <form onSubmit={handleSubmitOrder} className="space-y-3.5">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-xs font-medium focus:outline-none focus:border-brand-blue disabled:opacity-50"
                      />
                    </div>
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <textarea
                        ...
                        className="w-full bg-white border border-gray-300 rounded-lg px-3 py-2 text-xs font-medium focus:outline-none focus:border-brand-blue resize-none disabled:opacity-50"
                      />
                    </div>

                    {/* Area Radio selectors */}
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <label className={`border rounded-lg p-2.5 flex items-center justify-center cursor-pointer transition-all ${
                          ...
                          <input
                            ...
                            className="sr-only"
                          />
                          <span className="text-[11px]">ঢাকা সিটি</span>
                        </label>
                        ...
                        <label className={`border rounded-lg p-2.5 flex items-center justify-center cursor-pointer transition-all ${
                          ...
                          <input
                            ...
                            className="sr-only"
                          />
                          <span className="text-[11px]">ঢাকার বাইরে</span>
                        </label>
                      </div>
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full py-3.5 mt-2 bg-brand-red hover:bg-brand-red/90 text-white rounded-xl font-extrabold text-xs flex items-center justify-center gap-2 shadow-lg shadow-brand-red/10 cursor-pointer transition-colors disabled:opacity-50"
                    >
                      {isSubmitting ? (
                        <>
